...
![Visualisation of 7-day rolling average and daily new cases](Daily_New_Covid_Cases_in_Greece_with_7_day_Rolling_Average.png) *Line plot visualizing the daily new cases with a seven-day rolling average and the raw daily cases*
